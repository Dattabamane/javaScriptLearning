...
console.log("A] ========using map() methode to transform array of Square==========");
    ...
    console.log("B] using map() methode transform array of Square in one line==========");
